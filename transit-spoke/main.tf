...
resource "aws_vpn_gateway_attachment" "vpn_attachment" {
  ...
  depends_on     = [aws_vpn_gateway.vpn_gw] # to avoid race conditions where terraform attempts to delete the vpn gateway when the vgw is still attached to the vpc  
}
